...
| GVHMR / GMR motion preprocessing | Ignored local clones plus the private processing-Pod evidence root documented in `docs/operations/setup_local_sync.md` | Public research-code provenance is zju3dv/GVHMR and YanjieZe/GMR. Model weights/body models, user recordings, generated retargets and the 2026-07-11 GMR recovery bundle remain ignored and must not be redistributed without their own license review. Git tracks only small content-addressed manifests and source/result bindings. |
