...
EXCLUDED: Dict[str, Dict[str, str]] = {
    ...
    "racket_contact_geometry.py": {
        "OBSERVED_RUBBER_STATUS_NONE": "grading_and_observation",
        "OBSERVED_RUBBER_STATUS_SELECTED": "grading_and_observation",
        "OBSERVED_RUBBER_STATUS_OPPOSITE": "grading_and_observation",
        "OBSERVED_RUBBER_STATUS_EDGE_RIM_AMBIGUOUS": "grading_and_observation",
        "OBSERVED_RUBBER_STATUS_BETWEEN_PLANES_AMBIGUOUS": "grading_and_observation",
        "OBSERVED_RUBBER_STATUS_INVALID_INPUT": "grading_and_observation",
        "torch_classify_observed_generic_racket_contact": "grading_and_observation",
    ...
    "stroke_adapt_torch.py": {
        ...
        "_clear_fixed_try_lm_cuda_graph_cache_for_tests": "self_check_only",
    },
    "strike_spec_torch.py": {
