...
_LOOP = VendorActionConfig(
    ...
    required_identity_manifest=ArtifactPin(
        ...
        "9acc45af41bbc3c227ac63bde80a5b30e67c3ea6777f7b00ca88dbf34a4ed6f9",
    ),
    runtime_contract=ArtifactPin(
    ...
    dynamic_ready_candidate=ArtifactPin(
        ...
        "95d9d99027b770c410ea6cd2e753849955cef9e138dff5aee83e1e330b4c28cc",
    ),
    nominal_hold_receipt=ArtifactPin(
        "configs/a3_vendor_dynamic_ready_20260802_r9/"
    ...
    contact_bundle=ArtifactPin(
        ...
        "bh_loop_c.bundle.v2.56cfea84f9ff.json",
        "56cfea84f9ffae0608645b5188c70f3f4f356bbc72a8403d3b0c50a65e88f964",
    ),
    fixed_domain_initial_receipt=ArtifactPin(
...
_BLOCK = VendorActionConfig(
    ...
    required_identity_manifest=ArtifactPin(
        ...
        "1744704ad648e4656ff80470eebdba6410751594f071abc20785da3544b6ce38",
    ),
    runtime_contract=ArtifactPin(
        "configs/a3_vendor_runtime_authority_20260802_r9/"
    ...
    runtime_authority_receipt=ArtifactPin(
        ...
        "9d4499bcabecbbd2766d614ac4ec427c6c0fc3a74457a4496737c4e4105c3b38",
    ),
    dynamic_ready_candidate=ArtifactPin(
        "configs/a3_vendor_dynamic_ready_20260802_r9/"
        "bh_block.dynamic_ready.v1.json",
        "d80e0c23f03cc0c0ca377074f22bf9b86e21f60600debb6c5f7c4e5a0f43fe46",
    ),
    nominal_hold_receipt=ArtifactPin(
        "configs/a3_vendor_dynamic_ready_20260802_r9/"
        "bh_block.nominal_hold.v1.json",
        "026fd87acee14459b55b149077ac42574bd43271b4aafc4f49406b968263fc57",
    ),
    contact_bundle=ArtifactPin(
        "configs/n1_contact_vendor_a3_20260802_r9/bh_block/"
        "bh_block.bundle.v2.cb4c7b125076.json",
        "cb4c7b1250761e3ecd314562c497a404746b029e2d28cfc8eb5e140ae2e89115",
    ),
    fixed_domain_initial_receipt=ArtifactPin(
        "configs/n1_fixed_domain_initial_20260802_r9/"
