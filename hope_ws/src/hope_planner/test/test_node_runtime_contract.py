...
def test_solve_cadence_preserves_every_sample_default_and_decimates_deterministically():
...
def test_ros_node_wires_one_corrected_base_to_flat_adaptive_x_and_side():
    ...
    assert "self._expire_formal_base_if_needed(time.monotonic())" in pose_callback
