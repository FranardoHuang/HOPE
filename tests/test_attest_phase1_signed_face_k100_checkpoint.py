...
SCRIPT = ROOT / "scripts/attest_phase1_signed_face_k100_checkpoint.py"
MANIFEST = ROOT / "configs/phase1_signed_face_k100_checkpoint_attestor_20260714.json"
...
A = _load(SCRIPT, "signed_k100_checkpoint_attestor_under_test")
...
def test_consumer_has_no_judge_launch_signal_ssh_or_robot_command_surface():
    ...
    assert "choices=(\"static-validate\", \"plan\", \"attest\")" in source
