...
| `C3/D3 K100 paired execution consumer` | 只消费已分别通过 checkpoint attestor 的 C3/D3 终档，在独立 eval worktree/runtime 中用同一 immutable K100 顺序判卷，并发布两侧 raw count 与 `D3-C3`；它不重跑训练，也不自动授权 L2、第二 seed 或 stop/promote。 |
