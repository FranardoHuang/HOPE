...
| 4 | model_9000 与我们候选的同板对比(缺 onnx 文件:请 dongc1 放 `/workspace/shared/models/`) | dongc1 + claude | 今晚 |
...
| 7 | 0703 打球录像 → 旋转归一 → 新参考 clip 验证(dongc1 的 re-ground 管线已做一版,确认覆盖) | dongc1 | 周六前 |
