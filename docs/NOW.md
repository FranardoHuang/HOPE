...
- **⚠ 口径补条(franco 07-09,fixE 终审教训)**:训练内上台率**报人一律用 rally 全分母口径**
  ...
  诊断辅尺。判卷器新开关:`--qdes-clamp`(对齐训练/部署剪切,建议一律开)、`--hold-ref stand|clip`
  (按代际选),移植中。
