...
一次性报告与已被取代的方案。**内容不改、不删**，只是移出阅读路径。
当前状态永远看 [`../NOW.md`](../NOW.md)，当前工序看 [`../INDEX.md`](../INDEX.md)。

| 文件 | 是什么 | 现在看哪 |
| --- | --- | --- |
| `PHASE1_SUMMARY_2026-07-10.md` | 第一阶段训练总结（一次性） | [NOW](../NOW.md) |
| `PHASE1_SCHEMA3_RESULTS_2026-07-11.md` | schema-v3 同题结果（一次性） | [EXP-P1-HISTORICAL-SCHEMA3](../experiments/2026-07/EXP-P1-HISTORICAL-SCHEMA3.md) |
