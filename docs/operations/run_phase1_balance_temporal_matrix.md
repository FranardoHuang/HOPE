...
- namespace：`/workspace/codexschema/phase1_balance_temporal_matrix_20260720b`
...
ssh <pod> 'ls /workspace/codexschema/phase1_balance_temporal_matrix_20260720b 2>&1'
...
```bash
PROBE_DIR=/workspace/codexschema/phase1_balance_temporal_matrix_20260720b/probes/<job_id>
