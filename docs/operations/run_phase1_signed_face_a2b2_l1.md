...
- manifest：[`phase1_signed_face_a2b2_l1_prereg_20260714.json`](../../configs/phase1_signed_face_a2b2_l1_prereg_20260714.json)，SHA `82106582679643fe65a562c434bdcd5048aca60b293c53e3088ec2dde260fab4`；
- launcher：[`run_phase1_signed_face_a2b2_l1.py`](../../scripts/run_phase1_signed_face_a2b2_l1.py)，SHA `db626e2958ae4b2e02f36e0e39e2c94064840bdc03cedc28712ad38066864534`；
...
当前结果：`18 passed`，`py_compile`、`static-validate`、plan 均 rc0。运行消费者只重复检查会改变本轮
