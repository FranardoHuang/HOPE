...
| RunPod `/workspace/codexschema/phase1_signed_face_rescue_20260713/source_50c49e5.bundle` and `source_50c49e5_git_evidence.txt` | Disaster-recovery source and clean-worktree proof for the epoch-1 signed-face v6/v6r1 training checkout | Private runtime evidence; bundle/evidence SHA-256 `2a794e2c...0a39e` / `12dc839f...c99`, bundle advertises `50c49e58a9413ec6ac1c3ed2565d9a78acdb5e64` and requires base `882fea4285f0cf9a97ba79d79ae8af31d26ea1ed` | G05 signed-face v6r1 D-only retry |
| RunPod `/workspace/codexschema/phase1_signed_face_rescue_20260713/{control/v6,runs/l1,l1_checkpoint_audit.jsonl,b_kill_action.txt,d_timeout_diagnostic.txt}` | Immutable foreign v6 control plus A/B/C terminal and D boot-timeout evidence consumed by the mixed L1 finalizer | Copy the complete exact evidence root from Pod1 or the reviewed local snapshot `/private/tmp/pod1_v6_foreign_20260713/`; foreign config/launcher SHA-256 `97779cee...eebf2` / `9463f228...85052`, checkpoint-audit SHA-256 `62076758...d354`. Do not edit or flatten paths on restore | G05 signed-face v6r1 D-only retry/finalizer |
| RunPod `/workspace/codexschema/phase1_signed_face_rescue_20260713/assets/schema3_exam_bank_rebind_v1/` | Accepted signed-face exam E2 rebound bank and report-last receipt | Bank/report are 63,643/18,795 bytes with SHA `60e1a7ad...d1ca` / `dd4332ed...ad0`; tracked ledger `configs/phase1_signed_face_exam_bank_rebind_results_20260714.json` binds full receipts. Restore both together; this does not restore a schedule or judge activation | G06 signed-face paper input |
...
### Signed-face epoch-1 v6/v6r1 private evidence
...
restore files while a trainer uses it. The v6r1 procedure and every outer-evidence SHA are frozen in
