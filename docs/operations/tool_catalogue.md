...
| `scripts/launch_mujoco_full_mdp_successor.py` | clean-Git、fresh `/workspace` root的portable Full-A H48 one-shot；核canonical Python、ready pose、plant、EPA48/RSL3/MJLab runtime stack、run-owned `runtime.mjb`、GPU UUID与lifetime flock。V7当前合同为PPO V5 `2048×25000/save500`、Reward28、V3 `215/231`与wire`10/5/6`；无monitor/retry/resume/signal/业务成功Gate。旧`caddecb7`是V6 negative只读证据，不得resume或复用namespace | 0/2/child rc | [现役训练边界](run_training.md#fullmdp-ppo-v5-observation-v3-current)；[实验真源](../experiments/2026-08/EXP-ACTION-BALL-FULLMDP-CURRICULUM-UNBLOCK-20260822.md#107-v6结论翻转生存形成但mimichit桥与joint经济失败) |
| `mujoco_full_mdp_longrun_consumer.py` | 独立消费exact schema-10 update/evidence、schema-5 completion并输出schema-6 summary；重验runtime/plant/MJB、Reward28/V3/PPO V5身份、paddle真实误差与fresh-prefix因果守恒。拒绝假分母与旧wire伪兼容，只审fresh `diagnostic_unauthorized`证据，不签ready/promotion/deploy | 0/1 | [现役训练边界](run_training.md#fullmdp-ppo-v5-observation-v3-current) |
| `scripts/launch_isaac_full_mdp_successor.py` | clean-Git、fresh `/workspace` root的Isaac Full-A H48 one-shot；核exact runtime/assets、GPU UUID与lifetime flock，绑定run-owned cache/training root。V7当前合同为PPO V5 `2048×25000/save500`、Reward28、V3 `215/231`、milestone schema8和四due/exhausted clock；terminal overlap不public且只在既有CPU drain做跨writer合成。旧`caddecb7`是V6 negative只读证据 | 0/2 | [现役训练边界](run_training.md#fullmdp-ppo-v5-observation-v3-current)；[课程解阻实验](../experiments/2026-08/EXP-ACTION-BALL-FULLMDP-CURRICULUM-UNBLOCK-20260822.md#107-v6结论翻转生存形成但mimichit桥与joint经济失败) |
