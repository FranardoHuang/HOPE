...
| `scripts/probe_mujoco_full_mdp_h48_tape.py` | **pre-V3历史工具**：用tracked SplitMix64 `N64×H48×31` tape跑portable Full-A env，保存旧Reward20、203/219 observation、plant和离散生命周期raw arrays；compare只给exact mismatch/difference envelope。源码未升级前不得代签Reward24/V3/PPO V5、final rate或promotion | 0/2 | [历史实验真源](../experiments/2026-08/EXP-ACTION-BALL-MUJOCO-PORTABLE-FULLA-20260819.md#h48-fixed-tape-and-rate-probes-20260821) |
...
| `scripts/launch_mujoco_full_mdp_successor.py` | clean-Git、fresh `/workspace` root的portable Full-A H48 one-shot；核canonical Python、ready pose、plant、EPA48/RSL3/MJLab runtime stack、run-owned `runtime.mjb`、GPU UUID与lifetime flock。当前合同为PPO V5 `2048×25000/save500`、Reward24、V3 `215/231`与wire`9/5/6`；无monitor/retry/resume/signal/业务成功Gate。final `caddecb7`已完成exact Pod、rate与fresh连续ACK；25k completion尚未完成，固定快照的contact/landing尚无eligible denominator，均为`未测` | 0/2/child rc | [现役训练边界](run_training.md#fullmdp-ppo-v5-observation-v3-current)；[实验真源](../experiments/2026-08/EXP-ACTION-BALL-FULLMDP-CURRICULUM-UNBLOCK-20260822.md#10-2026-08-25-currentv5反例收口与v6最小桥修复) |
| `mujoco_full_mdp_longrun_consumer.py` | 独立消费exact schema-9 update/evidence、schema-5 completion并输出schema-6 summary；重验runtime/plant/MJB、Reward24/V3/PPO V5身份、Mu cause及fresh-prefix因果守恒。拒绝假分母与旧wire伪兼容，只审fresh `diagnostic_unauthorized`证据，不签ready/promotion/deploy | 0/1 | [现役训练边界](run_training.md#fullmdp-ppo-v5-observation-v3-current) |
| `scripts/launch_isaac_full_mdp_successor.py` | clean-Git、fresh `/workspace` root的Isaac Full-A H48 one-shot；核exact runtime/assets、GPU UUID与lifetime flock，绑定run-owned cache/training root。当前合同为PPO V5 `2048×25000/save500`、Reward24、V3 `215/231`和四due/exhausted clock；terminal overlap不public且只在既有CPU drain做跨writer合成。final `caddecb7`已完成exact Pod、rate与fresh连续ACK；25k completion尚未完成，固定快照尚无row活到首个due，task/playback/launch/contact/landing均为`未测` | 0/2 | [现役训练边界](run_training.md#fullmdp-ppo-v5-observation-v3-current)；[课程解阻实验](../experiments/2026-08/EXP-ACTION-BALL-FULLMDP-CURRICULUM-UNBLOCK-20260822.md#10-2026-08-25-currentv5反例收口与v6最小桥修复) |
| `mujoco_gpu_ac_full_mdp_wait_rsl3.py --full-a --diagnostic-rate-probe` | 真实portable Full-A PPO V5热路固定跑`2048×H48×61`（10 warm-up/50 measured/1 tail）；profiler-off，报告raw wall/p50/p90/transitions/s/peak CUDA且不写snapshot/completion。final实测Mu p50/p90=`5.468/5.526 s`；probe不能替代fresh学习或成为Gate，正式入口仍25000 | 0/2 | [现役训练边界](run_training.md#fullmdp-ppo-v5-observation-v3-current)；[性能真源](../experiments/2026-08/EXP-ACTION-BALL-FULLMDP-HOTPATH-20260819.md#fullmdp-v6-rate-current) |
