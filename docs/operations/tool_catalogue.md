...
| `scripts/build_mujoco_warp_epa48.py` | 从exact `mujoco-warp==3.10.0.3` sdist离线应用tracked两文件patch，no-clobber构建/只读复核[`3.10.0.3+hope.epa48.1`](../DEFINITIONS.md#mujoco-warp-epa48-fork) wheel；硬验source allowlist、281-file package payload、ZIP/RECORD、receipt与wheel SHA并记录builder身份。只关闭supply chain，不代签24-fail/48-pass physics fixture或训练授权 | 0/2 | [恢复/构建](setup_local_sync.md#restore-and-build-the-project-owned-mujoco-warp-epa48-fork)；[G06](../gates/G06_isaac_to_mujoco.md) |
