...
| [EXP-P1-BALANCE-ACTION-SLEW-20260720](2026-07/EXP-P1-BALANCE-ACTION-SLEW-20260720.md) | 腿腰恢复期 processed-q_des 突变铰链能否比全身 raw-action dense 平滑更好地降摔而不伤击球？ | Franco | Codex | ready | E3 mechanics / E1 result | [Wave A/B](../DEFINITIONS.md#balance-stability-waves)：probe7/v6 的 W-C、V-C、V-N 得到三份 exact receipt；W-N 在 scene boot 冻结并由 locked watchdog TERM/KILL，W-H/V-H 未发。这是 infrastructure transient，不是 Reward 结果；v6 禁止重试/混收据。[probe8 fresh v7 替换探针](../DEFINITIONS.md#balance-probe-generations)尚未发射，必须先让 W-N canary 取得 receipt，再发其他五格 |
