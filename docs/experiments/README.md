...
| --- | --- | --- | --- | --- | --- | --- |
| [EXP-ACTION-BALL-MUJOCO-PORTABLE-FULLA-20260819](2026-08/EXP-ACTION-BALL-MUJOCO-PORTABLE-FULLA-20260819.md) | portable MuJoCo怎样逐纵切片消费同一slot0题目、teacher与生命周期，直到可做4096长跑？ | Franco | Codex | action-affine-and-ledger-host-validated | E1 source/host | default reset、`2+293k` cadence、phase8 RETIRE与26-event engineering surface已闭合；同一env原子epoch事件阻止跨env边际代签，consumer分开engineering/business完成，q-des guard仍跨引擎不同，Pod真实调用点及live 25k未测/未启动 |
