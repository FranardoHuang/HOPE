...
| [EXP-P1-BALANCE-ACTION-SLEW-20260720](2026-07/EXP-P1-BALANCE-ACTION-SLEW-20260720.md) | 腿腰恢复期 processed-q_des 突变铰链能否比全身 raw-action dense 平滑更好地降摔而不伤击球？ | Franco | Codex | ready | E3 mechanics / E1 result | [Wave A/B](../DEFINITIONS.md#balance-stability-waves)：probe5 只得到 `5/6` 份 exact receipt；probe6/v5 W-C 又因 transaction wrapper 破坏 multiline Python 参数而在 trainer 前 fail closed，其余五格未发，两代均无机制结论。[probe7 fresh v6 替换探针](../DEFINITIONS.md#balance-probe-generations)已冻结但尚未发射；必须收齐该代六份 exact receipt，禁止混用旧代收据 |
