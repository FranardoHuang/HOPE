...
| [EXP-P1-BALANCE-ACTION-SLEW-20260720](2026-07/EXP-P1-BALANCE-ACTION-SLEW-20260720.md) | 腿腰恢复期 processed-q_des 突变铰链能否比全身 raw-action dense 平滑更好地降摔而不伤击球？ | Franco | Codex | ready | E3 mechanics / E1 result | [Wave A/B](../DEFINITIONS.md#balance-stability-waves)：[probe5 第五代非科学六格完整场景探针](../DEFINITIONS.md#balance-probe-generations)只得到 `5/6` 份 exact receipt；W-H 在 trainer 启动前的 exec 身份过渡窗口 fail closed，整代不能解锁训练。[probe6 第六代 fresh v5 manifest-bound 替换探针](../DEFINITIONS.md#balance-probe-generations)已冻结但尚未发射；必须收齐该代六份 exact receipt，禁止混用 probe5 收据 |
