...
| [EXP-P1-BALANCE-ACTION-SLEW-20260720](2026-07/EXP-P1-BALANCE-ACTION-SLEW-20260720.md) | 腿腰恢复期 processed-q_des 突变铰链能否比全身 raw-action dense 平滑更好地降摔而不伤击球？ | Franco | Codex | ready | E2 input / E1 Wave A | [Wave A/B](../DEFINITIONS.md#balance-stability-waves)：A 六格已 manifest-bound 但尚未启动，先过六份 probe receipt；B 的 [M0](../DEFINITIONS.md#motion-m0) moving teacher 已拒绝，只继续静态 v4rg/non-demo 合同设计 |
