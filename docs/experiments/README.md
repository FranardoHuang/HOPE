...
| [EXP-P1-LONG-SCALEOUT-SIX-ARM](2026-07/EXP-P1-LONG-SCALEOUT-SIX-ARM.md) | 两张空卡能否用同一长曲线补齐模仿 `2×2`、关节速度与脚部朝向剂量曲线？ | Franco | Codex | ready | E1 | 六格共同 seed3、10000 updates，按 GPU0/GPU1 逐圈铺开；稀疏击球样本不足时必须继续，不买第二 seed |
