...
| [EXP-P1-V1V2-BASE-DECEL-MEASUREMENT-RERUN](2026-07/EXP-P1-V1V2-BASE-DECEL-MEASUREMENT-RERUN.md) | 补齐共同机制 activation 后，base-decel 权重 1 是否净改善平衡且不伤击球？ | Franco | Codex | running / +200 invalid | E2 | 两臂 model200 身份通过；post-swing eligible/selected/started 全零，+200 不判行为，继续到 +500 |
