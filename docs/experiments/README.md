...
| [EXP-P1-SIGNED-FACE-RESCUE-FUNNEL](2026-07/EXP-P1-SIGNED-FACE-RESCUE-FUNNEL.md) | 拍面诚实修复后，线性角度引导能否用单 seed 脱离反面死区？ | franco | Codex | running/partial | E3 historical + E1 C2/D2 source gate | 旧 v6/v8 第四格 pre-contract timeout 不采用；新 C2/D2 已修复 guidance hard-contract + outer claim provenance，按 Pod1 GPU1/GPU2 boot 串行/训练并发，尚未 runtime；L2/judge/第二 seed阻断 |
