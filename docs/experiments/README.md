...
| --- | --- | --- | --- | --- | --- | --- |
| [EXP-ACTION-BALL-PHASED-READINESS-20260730](2026-07/EXP-ACTION-BALL-PHASED-READINESS-20260730.md) | 首个 N1、1000 update、formal N5、N73 与部署各自最迟必须闭合哪些训练、观测、吞吐和安全合同？ | Franco | Codex | running | E2 | 三条 compatibility 194-D stable-ready `4096×1001` 已在 Pod1 运行；fresh 采用显式 teacher-start 的 195-D N1，尚缺 Pod 构造 smoke。formal 收据热路径与新 OptiTrack physics 最迟 N5 前收口；外部 OptiTrack/A3/真机输入单列在账本 §3.6 |
