...
| [EXP-P1-BALANCE-ACTION-SLEW-20260720](2026-07/EXP-P1-BALANCE-ACTION-SLEW-20260720.md) | 腿腰恢复期 processed-q_des 突变铰链能否比全身 raw-action dense 平滑更好地降摔而不伤击球？ | Franco | Codex | ready | E3 mechanics / E1 result | [Wave A/B](../DEFINITIONS.md#balance-stability-waves)：probe9/v8 已在 `04:14:32–04:22:42Z` 按 W-N→W-C→W-H→V-C→V-N→V-H 全局串行完成，六格均 natural exit=`0`、first iteration/exact verifier/closure 通过；receipt-set `cc9ff591…d9c8`。W-N/GPU0 与 W-C/GPU1 通过不证明 GPU 等价、不抹除 probe7/8，probe 不是科学结果。`16263be5` 上的 same-swapped `1001`-update 长训制品 `fc6f1ea3…02df` 只是未执行的合入前历史 render；须在当前 `main` 重渲染审计，结论仍 `inconclusive/not adopted` |
