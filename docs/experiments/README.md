...
| [EXP-P1-SIGNED-FACE-RESCUE-FUNNEL](2026-07/EXP-P1-SIGNED-FACE-RESCUE-FUNNEL.md) | 拍面诚实修复后，线性角度引导能否用单 seed 脱离反面死区？ | franco | Codex | running/partial | E3 partial + E1 v6r2 | original-v6 与 foreign-v8 都在前三格终档后第 4 格 D 卡在 Kit/scene-start boot；根因未知，v6r2 只修 source validator 且未启动；先查 boot 根因，L1 activation/L2/judge/第二 seed 保持阻断 |
