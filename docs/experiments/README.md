...
| [EXP-P1-LONG-NO-REPLAY-FUNNEL](2026-07/EXP-P1-LONG-NO-REPLAY-FUNNEL.md) | 早筛的 qdot 与 V1+V2 信号能否在无随挥回放的 10000-update 同源长曲线中保持？ | Franco | Codex | ready | E2 source/scene probe | 三格共用一个普通对照；200/500/1000 只早筛，2000/3000 看中段，6000/10000 看完整曲线 |
