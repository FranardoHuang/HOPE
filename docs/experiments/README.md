...
| [EXP-P1-SIGNED-FACE-RESCUE-FUNNEL](2026-07/EXP-P1-SIGNED-FACE-RESCUE-FUNNEL.md) | 拍面诚实修复后，线性角度引导能否用单 seed 脱离反面死区？ | franco | Codex | running/partial | E3 historical + E1 | C2 真实 plant 与零摩擦声明矛盾，D2 永久不发；新 C3/D3 source gate 已闭合，runtime/L2/judge/第二 seed仍阻断 |
| [EXP-P1-SIGNED-FACE-C3D3-ZERO-FRICTION-L1](2026-07/EXP-P1-SIGNED-FACE-C3D3-ZERO-FRICTION-L1.md) | 显式零摩擦能否从 argv 到 checkpoint 完整闭合，并形成 guidance off/on 的 fresh L1 配对？ | Franco | Codex | preregistered | E1 | source/static/攻击门通过；Pod runtime 尚未执行，不提供行为结论 |
