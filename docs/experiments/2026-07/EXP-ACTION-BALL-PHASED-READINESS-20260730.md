...
| 项 | 证据 | 当前边界 |
| --- | --- | --- |
| fixed-194 v2 fresh r3 specs | smoke / probe / milestone1000 三份 canonical spec 均绑定 exact source `8729104e6c9a…46c4`、fast-ball bundle `3c1076e3…c32b`、Pod1 GPU2 UUID、seed0 与 fixed `current_low` Reward；raw JSON SHA 依次为 `e1b63f00…5b8d`、`3b200542…dd34`、`b0396fbe…d442`，namespace 全部 fresh `_r3` | 第一版缩进 JSON 在创建 namespace 前被 canonical-byte 门拒绝，已机械规范化且不覆盖旧 operator-control 目录；新 spec 仍须由 source commit A 重新 plan/claim |
