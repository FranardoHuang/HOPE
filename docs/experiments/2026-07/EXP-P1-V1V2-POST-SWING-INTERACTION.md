...
- 状态：`blocked`（V1/V2/post-swing activation source `9d7c6b2...` 已 exact 绑定；等待该 source 自己的 strict full-scene probe）
...
| 字段 | 冻结值 |
| --- | --- |
| Source | clean exact `9d7c6b2b01b6392df918c0ab69bbb89b1beb4eaf` / `/workspace/codexschema/nohope_p1_v1v2_post_swing_activation_9d7c6b2`；含 V1、V2、post-swing activation counters/logger，但 strict probe 尚未运行 |
...
`9d7c6b2...`，必须在这个新 detached checkout 重跑 strict full-scene terminal probe，审核通过后才能用另一个
...
| --- | --- | --- | --- | --- | --- |
| V1+V2、随挥后重放概率 0.25 对照；`phase1_fresh_c_v1v2_post_swing_p025_control_seed3_20260714` | blocked | `200/500/1000`，seed 3 | exact `9d7c6b2...` source 单测；新 strict probe 尚缺 | 无 | 不得发射 |
