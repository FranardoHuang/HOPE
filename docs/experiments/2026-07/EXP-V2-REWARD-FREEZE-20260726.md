...
reward-scale 队列三臂(defer0 / treat_r3 / table_r12)已于 07-27 00:09 前后为 banked C-group
波腾卡而停止,终档 `model_3940 / 4187 / 3966`,**未跑到 20k,§0.9 的"在跑"状态作废**。
4k 截面终读(窗口 legal/strike | 摔/回合):table_r12 **0.0503 | 0.0060** ≫ defer0
0.0187 | 0.0144 > r3 0.0084 | 0.0078。方向性结论维持 §0.9 的 3.8k 中期判断:**上台奖 1.2×
最优、延付有害**;该结论进入下一代配方(banked 谱系)的默认面。face_rescue 及以后各臂未发,
队列由 banked C-group 波(见 [EXP-BANKED-CGROUP-BHLOOPC-20260727](EXP-BANKED-CGROUP-BHLOOPC-20260727.md))
接替,不再补发 v4rg 谱系臂。
