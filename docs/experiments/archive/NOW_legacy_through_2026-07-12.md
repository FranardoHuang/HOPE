# 归档 — 截至 2026-07-12 的旧 NOW

这是冻结的旧流水，不得当作当前状态或操作说明。当前入口是
[`docs/NOW.md`](../../NOW.md)。文件移动后只修复了相对链接；下方原文故意保持历史原样，
不与现行结论对账。
...
[PROGRESS.md](PROGRESS_legacy_through_2026-07-12.md)(2026-07-06 大重排:过期章节全部原样搬去那里);
