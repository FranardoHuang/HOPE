...
| [`EXP-P1-SIGNED-FACE-RESCUE-FUNNEL`](experiments/2026-07/EXP-P1-SIGNED-FACE-RESCUE-FUNNEL.md) | E3 partial：foreign v8 A/B/C 串行前序终档，D 第四格第二次 pre-contract boot timeout；自动重试停止，L1 activation/L2/判卷继续阻断 |
